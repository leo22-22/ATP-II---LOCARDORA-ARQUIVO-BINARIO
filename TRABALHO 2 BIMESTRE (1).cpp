...
void ExclusaoClienteLogica(){
	...
	while(stricmp(CPF,"\0")!=0){
		...
		if(pos == -1){
			...
			printf("### EXCLUI CLIENTE ###");
			gotoxy(95,20);
			printf("CLIENTE EXCLUIDO E LOCACOES EXCLUIDAS");
			Sleep(3000);
		}
		clrscr();
		ExibeTelaoResp();
...
void ExclusaoClienteFisica(){
	...
	ExibeTelaoResp();
	gotoxy(90,14);
	printf("### EXCLUSAO FISICA CLIENTE  ###");
	gotoxy(67,16);
	...
	while(strcmp(CPF,"\0")!=0)
	{
		...
		if(pos == -1)
		{
			...
			if(toupper(getche())=='S'){
				...
				gotoxy(67,21);
				printf("Cliente Excluido do Banco de Dados");
				...
				gotoxy(67,22);
				printf("Locacao excluida do banco de dados");
			}
		}
		getch();
		ExibeTelaoResp();
...
void ExclusaoCarroFisica(){
	...
	ExibeTelaoResp();
	gotoxy(90,14);
	printf("### EXCLUI FISICA DE CARROS ###");
	gotoxy(67,16);
	...
	while(Cod!=0)
	{
		...
		if(pos == -1)
		{
			...
			if(toupper(getche())=='S'){
				...
				printf("### EXCLUI FISICA DE CARROS ###");
				gotoxy(95,20);
				printf("Carro excluido do banco de dados");
			}
		}
		getch();
		ExibeTelaoResp();
...
void ExclusaoLocacaoFisica(){
	...
	ExibeTelaoResp();
	gotoxy(90,14);
	printf("Exclusao Fisica de Locacao");
	gotoxy(67,16);
	printf("Digite um CPF: ");
	gets(CPF);
	while(strcmp(CPF,"\0")!=0)
